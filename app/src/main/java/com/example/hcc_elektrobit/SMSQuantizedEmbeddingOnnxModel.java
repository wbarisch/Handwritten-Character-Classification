...
public class SMSQuantizedEmbeddingOnnxModel {
    private static SMSQuantizedEmbeddingOnnxModel INSTANCE = null;
    ...
    private SMSQuantizedEmbeddingOnnxModel() {
        try {
    ...
    public static SMSQuantizedEmbeddingOnnxModel getInstance() {
        if (INSTANCE == null) {
            synchronized (SMSQuantizedEmbeddingOnnxModel.class) {
                if (INSTANCE == null) {
                    INSTANCE = new SMSQuantizedEmbeddingOnnxModel();
                }
            }
        }
        return INSTANCE;
    ...
    private String copyModelToCache() throws IOException {
        String modelFileName = "siamese_embedding_model_mine_245_quantized.onnx";
